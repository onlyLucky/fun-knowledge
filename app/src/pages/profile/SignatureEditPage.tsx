    ...
    <div className="flex flex-col h-full bg-bg-page relative">
      ...
      <div className="bg-bg-page shrink-0">
        <div className="flex items-center justify-between px-5 py-4">
          ...
          <span className="text-[16px] font-bold text-text-main">修改签名</span>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-5 pt-4 pb-10">
        ...
        <div className="bg-bg-card rounded-[18px] px-5 py-4 border border-border/50 shadow-[0_2px_8px_rgba(41,37,38,0.04)]">
          <p className="text-[11px] font-medium text-text-muted mb-2">个性签名</p>
          <textarea
            value={signature}
            ...
            className="w-full text-[15px] text-text-main bg-transparent outline-none resize-none placeholder:text-[#DFDEDE] disabled:opacity-50"
          />
