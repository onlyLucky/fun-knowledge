            ...
            <div className="px-5 pb-10">
              {submitted ? (
                ...
                >
                  ...
                  <p className="text-[15px] font-bold text-text-main">感谢你的反馈！</p>
                ...
                <>
                  <div className="flex items-center justify-between mb-5 pt-2">
                    <div>
                      <h3 className="text-[16px] font-bold text-text-main">内容纠错</h3>
                      <p className="text-[11px] text-text-muted mt-0.5">选择错误类型，帮助我们改进</p>
                    </div>
                    <motion.button
                      whileTap={{ scale: 0.88 }}
                      onClick={handleClose}
                      className="w-[32px] h-[32px] bg-bg-page rounded-[10px] flex items-center justify-center"
                    >
                      ...
                      <motion.button
                        ...
                        className={`px-3.5 py-2 rounded-[100px] text-[12px] font-medium border transition-all ${
                          selectedReason === r
                            ...
                            : 'bg-bg-page text-text-sub border-border'
                        }`}
                      >
                        {r}
                      </motion.button>
                  ...
                  <textarea
                    ...
                    placeholder="补充说明（选填）..."
                    rows={3}
                    className="w-full bg-bg-page rounded-[14px] px-4 py-3 text-[13px] text-text-main placeholder:text-[#DFDEDE] outline-none resize-none border border-border/50 mb-4"
                  />
